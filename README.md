<div align="center">
  ...
  <h1>KeybindPlus (1.18.x)</h1>
  <p><strong>Client-side keybind profile manager, in-game editor, and conflict resolver for Minecraft.</strong></p>

  [![Build Status](https://github.com/KVdz00/keybindplus/actions/workflows/build.yml/badge.svg?branch=1.18.x)](https://github.com/KVdz00/keybindplus/actions)
  [![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
  [![Minecraft Version](https://img.shields.io/badge/Minecraft-1.18.2-orange.svg)](VERSIONS.md)
</div>
...
> - This branch (`1.18.x`) is an experimental port for **Minecraft 1.18.2** (Fabric & Forge).
...
- **Minecraft Version**: 1.18.2 (Experimental Beta)
- **Supported Loaders**: Fabric Loader (`>=0.14.0`) & Forge (`>=40.2.21`)
- **Required Dependencies**: Architectury API (`>=4.12.94`), Fabric API (Fabric only)
